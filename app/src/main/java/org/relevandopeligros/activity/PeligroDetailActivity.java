...
/**
 * An activity representing a single Peligro detail screen. This
 * activity is only used on handset devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link PeligroListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing
 * more than a {@link PeligroDetailFragment}.
 */
public class PeligroDetailActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_peligro_detail);
        ...
        if (savedInstanceState == null) {
            ...
            getFragmentManager().beginTransaction()
                    .add(R.id.peligro_detail_container, fragment)
                    .commit();
        }
    }
